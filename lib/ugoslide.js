(function() {
  ...
  UgoSlide = (function() {
    ...
    UgoSlide.prototype.compile = function() {
      var $el, $word, count, css, eachTextNode, k, word, wordCounts, wordCountsSum, _, _i, _len, _ref, _ref1,
        _this = this;
    ...
    UgoSlide.prototype.showAt = function(index, force) {
      ...
      if (this.index != null) {
        this.pages[this.index].css('opacity', 0);
      }
      this.index = index;
      if (index == null) {
        return;
    ...
    UgoSlide.prototype.transitionDuration = function(word) {
      return Math.max(1.3 - word.length / 12, 0.2);
    };
